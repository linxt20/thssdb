...
public class JointRow extends Row {
  ...
  /** 描述：将columntype转换成comparertype 参数：columntype 返回：comparertype */
  ...
  /**
   * 描述：将TableName.ColumnName形式的变量拆分出TableName,ColumnName 参数：全名
  ...
  /** 描述：给定列，返回对应取值对应的comparer 参数：全名 返回：取值 */
